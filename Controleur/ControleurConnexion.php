...
class ControleurConnexion extends Controleur
{
    ...
    {
        $this->genererVue();//index.php de la vue administration
    }
    ...
    public function connecter()
    {
        if ($this->requete->existeParametre("admin") && $this->requete->existeParametre("pwd")) {
            ...
            if ($this->utilisateur->connecter($admin, $pwd)) {
                ...
                $this->genererVue(array('msgErreur' => 'Identifiant ou mot de passe incorrects', "index"));
            }

        else
            {
                throw new Exception("Impossible : identifiant ou mot de passe non défini");
            }
        }
    }
